...
class Ui_OutWarehouseMTDialog(object):
    def setupUi(self, OutWarehouseMTDialog):
        ...
        OutWarehouseMTDialog.resize(582, 271)
        ...
        self.gridLayout.addWidget(self.stock_out_dateTime, 1, 3, 1, 1)
        ...
        self.stock_out_remark_plainTextEdit.setMinimumSize(QSize(500, 0))
        self.stock_out_remark_plainTextEdit.setMaximumSize(QSize(16777215, 100))

        self.gridLayout.addWidget(self.stock_out_remark_plainTextEdit, 2, 1, 1, 3)
    ...
    def retranslateUi(self, OutWarehouseMTDialog):
        ...
        self.label_5.setText(QCoreApplication.translate("OutWarehouseMTDialog", u"\u51fa\u5e93\u603b\u6570", None))
