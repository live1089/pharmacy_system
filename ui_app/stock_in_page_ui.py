...
class Ui_StockDialog(object):
    def setupUi(self, StockDialog):
        ...
        self.gridLayout.addWidget(self.valid_date_edit, 7, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.operator_combox, 3, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.inbound_amount_double, 4, 5, 1, 1)
