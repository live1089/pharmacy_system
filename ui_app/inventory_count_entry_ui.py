...
class Ui_InventoryCountDialog(object):
    def setupUi(self, InventoryCountDialog):
        ...
        sizePolicy.setHeightForWidth(self.inventory_count_batch_combox.sizePolicy().hasHeightForWidth())
        self.inventory_count_batch_combox.setSizePolicy(sizePolicy)
        self.inventory_count_batch_combox.setMinimumSize(QSize(240, 0))
        ...
        self.inventory_count_plainTextEdit.setMinimumSize(QSize(420, 0))
        self.inventory_count_plainTextEdit.setMaximumSize(QSize(16777215, 60))

        self.gridLayout.addWidget(self.inventory_count_plainTextEdit, 3, 1, 1, 3)
        ...
        self.inventory_count_drug_comboBox.setDuplicatesEnabled(False)
