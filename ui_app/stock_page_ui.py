...
class Ui_StockDialog(object):
    def setupUi(self, StockDialog):
        ...
        self.gridLayout.addWidget(self.Production_lot_number_line_edit, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.valid_date_edit, 10, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.inbound_amount_double, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.warehousing_remarks_plain_text_edit, 11, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.supplier_stock_combox, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.operator_combox, 4, 3, 1, 1)
        ...
        self.batch_spin_box.setMaximum(999999999)

        self.gridLayout.addWidget(self.batch_spin_box, 6, 1, 1, 1)
