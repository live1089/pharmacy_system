...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(531, 202)
        Dialog.setMinimumSize(QSize(531, 202))
        Dialog.setMaximumSize(QSize(531, 202))
        ...
        self.unit_combox = QComboBox(Dialog)
        self.unit_combox.setObjectName(u"unit_combox")

        self.gridLayout.addWidget(self.unit_combox, 2, 3, 1, 1)

        self.drug_specification_combox = QComboBox(Dialog)
        self.drug_specification_combox.setObjectName(u"drug_specification_combox")

        self.gridLayout.addWidget(self.drug_specification_combox, 1, 3, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_7.setText(QCoreApplication.translate("Dialog", u"\u6700\u5c0f\u5355\u4f4d", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"\u89c4      \u683c", None))
