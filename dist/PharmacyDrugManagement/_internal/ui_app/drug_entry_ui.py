...
class Ui_DrugEntryDialog(object):
    def setupUi(self, DrugEntryDialog):
        ...
        self.purchase_unit_price_spin_box.setMaximum(999999999)
        ...
        self.label_4 = QLabel(DrugEntryDialog)
        ...
        self.gridLayout.addWidget(self.location_line_edit, 10, 1, 1, 1)
        ...
        self.drug_entry_batch_line_edit = QLineEdit(DrugEntryDialog)
        self.drug_entry_batch_line_edit.setObjectName(u"drug_entry_batch_line_edit")

        self.gridLayout.addWidget(self.drug_entry_batch_line_edit, 8, 1, 1, 1)
    ...
    def retranslateUi(self, DrugEntryDialog):
        ...
        self.label_4.setText(QCoreApplication.translate("DrugEntryDialog", u"\u6279\u53f7", None))
